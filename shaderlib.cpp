...
void CVoxShader::LocateUniforms(){
    this->LocateUniform("selection_id", this->selection_id);
    this->LocateUniform("time", this->time);
    this->LocateUniform("highlight_color", this->highlight_color);
...
void CQuadShader::LocateUniforms(){
    ...
    this->LocateUniform("normal_texture", this->normal_texture);
    this->LocateUniform("index_texture", this->index_texture);
    this->LocateUniform("light_direction", this->light_direction);
    this->LocateUniform("option", this->option);
}
